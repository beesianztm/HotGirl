...
public class StaggeredGridView extends ScrollView{
	...
	private Mode mMode = Mode.DYNAMIC;
	...
	private void addToLayout(StaggeredGridViewItem item, int columnIndex) {
		...
		final View itemView = item.getView(mGridViewItems.indexOf(item),inflater,parent);//change to showedItemCount
